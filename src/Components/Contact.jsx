...
const Contact = () => {
    return (
        <div name="Contact" className='w-full h-screen mx-auto px-8 flex flex-col justify-center'>
            <h1 className='pl-9 sm:text-center sm:pl-0'>Contact</h1>
            <p className='text-gray-200 text-2xl font-medium px-9 py-2 sm:text-center'>Reach me by sending an email using the form below:</p>

            <div className='lg:flex lg:items-center lg:justify-center'>
                <form className='grid px-9 text-xl sm:px-20 md:px-40 lg:w-2/3'>
