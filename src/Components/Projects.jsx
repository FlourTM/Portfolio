                ...
                <div className='grid grid-flow-col gap-3 px-3 overflow-x-auto sm:gap-8 sm:px-0 xl:justify-center'>
                    <form action='https://github.com/FlourTM/Best-Pets' target='_blank'>
                        ...
                        bg-cover bg-center w-[324px] h-[324px] px-4 py-4 flex flex-col">
                            ...
                            <p className='text-fontbody text-m py-3'>An adoption agency website application for a Human Computer Interaction course project. It features available
                    ...
                    <form action='https://github.com/CodeBlockStudios/Portfolio-Template' target='_blank'>
                        ...
                        bg-cover bg-center w-[324px] h-[324px] px-4 py-4 flex flex-col">
                            ...
                            <p className='text-fontbody text-m py-3'>A portfolio template that allows the user to show off key details about themselves, such as languages and applications
